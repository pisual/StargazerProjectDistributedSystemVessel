...
public class InjectServerListener extends StandardWorkInServiceListener{
	...
	public void running() {
		super.running();
		baseLog.INFO(this, "Stargazer ServiceControlSystem Report : injectServer Server Run");
	}
	...
	public void stopping(State from) {
		super.stopping(from);
		baseLog.INFO(this, "Stargazer ServiceControlSystem Report : injectServer Server Stopping");
	}
	...
	public void terminated(State from) {
		...
		baseLog.INFO(this, "Stargazer ServiceControlSystem Report : injectServer Server Terminated");
	}
	...
	public void failed(State from, Throwable failure) {
		...
		baseLog.INFO(this, "Stargazer ServiceControlSystem Report : injectServer Server Failed");
	}
