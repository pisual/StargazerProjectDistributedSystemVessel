...
@Services(name="logQueueServerManage", serviceZone = ServiceZone.System, layer = 3)
public class LogQueueServerManage extends AbstractIdleService{
	...
	* **/
	...
	private LogQueueServerManage() {}
	
	/**
	* @name 常规初始化构造
	* @illustrate 基于外部参数进行注入
	* **/
	public LogQueueServerManage(Optional<StanderServiceShell> logQueueServerArg, Optional<Listener> workInServiceControlListenerArg) {
		logQueueServer = logQueueServerArg.get();
