...
@Services(value="orderExportQueueServerManage", order = 101)
public class OrderExportQueueServerManage extends AbstractIdleService{
	...
	* **/
	...
	private OrderExportQueueServerManage() {
		super();
	}
	...
	* **/
	public OrderExportQueueServerManage(Optional<StanderServiceShell> orderExportQueueServerArg, Optional<Listener> workInServiceControlListenerArg) {
		super();
		orderExportQueueServer = orderExportQueueServerArg.get();
