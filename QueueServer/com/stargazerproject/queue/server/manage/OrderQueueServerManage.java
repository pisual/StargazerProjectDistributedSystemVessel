...
public class OrderQueueServerManage extends AbstractIdleService{
	
	/** @illustrate orderCacheServer的ServiceShell接口 **/
	@Autowired
	@Qualifier("orderQueue")
	private StanderServiceShell orderQueueServer;
	...
	protected void startUp() throws Exception {
		orderQueueServer.startUp();
	}
	
	/** @illustrate 关闭服务及相关操作 **/
	@Override
	protected void shutDown() throws Exception {
		orderQueueServer.shutDown();
	}
