 ...
 *  @author Felixerio
 *  **/
@Component(value="componentsCharacteristicServerManage")
@Qualifier("componentsCharacteristicServerManage")
@Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
@Services(value="componentsCharacteristicServerManage", order = 0)
public class ComponentsCharacteristicServerManage extends AbstractIdleService{
	...
	/** @construction 初始化构造 **/
	public ComponentsCharacteristicServerManage() {}
