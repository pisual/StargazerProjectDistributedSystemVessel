...
public final class ClientConnectingZookeeper extends ZookeeperInitialize implements ClientZookeeperMethod{
	
	private static ClientConnectingZookeeper clientConnectingZookeeper;
	
	public static ClientConnectingZookeeper getInstance(){
		if(null == clientConnectingZookeeper){
			clientConnectingZookeeper = new ClientConnectingZookeeper();
		}
		return clientConnectingZookeeper;
	}
	
	private ClientConnectingZookeeper() {
		super();
	}
