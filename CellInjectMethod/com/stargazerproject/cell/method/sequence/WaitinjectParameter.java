...
@Component(value="waitinjectParameter")
@Qualifier("waitinjectParameter")
@Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
public class WaitinjectParameter implements CellsTransaction<String, String>{
	...
	public WaitinjectParameter() {super();}
	...
	* **/
	@Override
	@HystrixCommand(commandKey = "waitinjectParameter", 
	                fallbackMethod = "fallBack", 
	                groupKey="waitinjectParameter", 
	                threadPoolKey = "waitinjectParameter",
	                commandProperties = {
