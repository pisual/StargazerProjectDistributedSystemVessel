...
public class OrderCacheServer implements StanderServiceShell{
	...
	public void startUp() {
		...
		Optional<LoadingCache<String, Order>> loadingCache = BeanContainer.instance().getBean(Optional.of("temporaryCacheOrderCacheLoadingCacheCharacteristic"), Optional.class);
