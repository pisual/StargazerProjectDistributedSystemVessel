package com.stargazerproject.test2;
...
public class ClassUtil {  
    ...
    public static void main(String[] args) throws MalformedURLException{  
        ...
        List<Class> classes = c.getClasssFromJarFile("/Users/Felixerio/Desktop/TestJar.jar","com");  
...
//		}  
     ...
     */
    public List<Class> getClasssFromJarFile(String jarPaht, String filePaht) throws MalformedURLException {
    	
        URL url1 = new URL("file:"+jarPaht);  
      ...
      for (JarEntry entry : jarEntryList) {
        ...
        try {
          ...
          clazzs.add(myClass1);
          System.out.println("已经加载类 "+ className);
    ...
    public static List<Class<?>> getClasses(String packageName){  
        ...
        try {  
            dirs = Thread.currentThread().getContextClassLoader().getSystemResources(packageDirName);  
